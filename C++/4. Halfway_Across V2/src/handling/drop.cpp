...
void handling::drop(MainWindow *mainWindow, QString target, Location* location) {
    ...
    if (itemIndex != -1) {
      ...
      if (locationItemIndex != -1) {
          location->setItemQuantity(locationItemIndex, location->getItemQuantity(locationItemIndex)+ 1);
      } else {
